...
export class Migration20230311191547 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "addresses" ("id" serial primary key, "country" varchar(255) not null, "state" varchar(255) not null, "city" varchar(255) not null, "street" varchar(255) not null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) not null, "supplier_id" int not null);');
    this.addSql('alter table "addresses" add constraint "addresses_supplier_id_unique" unique ("supplier_id");');

    this.addSql('create table "categories" ("id" serial primary key, "name" varchar(255) not null, "description" varchar(255) not null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null);');
