...
export class Migration20230320112127 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "addresses" ("id" serial primary key, "country" varchar(255) not null, "state" varchar(255) not null, "city" varchar(255) not null, "street" varchar(255) not null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null);');
    ...
    this.addSql('create table "stores" ("id" serial primary key, "name" varchar(255) not null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "address_id" int null);');
    ...
    this.addSql('create table "suppliers" ("id" serial primary key, "name" varchar(255) not null, "email" varchar(255) not null, "phone" varchar(255) not null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "deleted_at" timestamptz(0) null, "address_id" int null);');
    ...
    this.addSql('alter table "stores" add constraint "stores_address_id_foreign" foreign key ("address_id") references "addresses" ("id") on update cascade on delete set null;');
    ...
    this.addSql('alter table "suppliers" add constraint "suppliers_address_id_foreign" foreign key ("address_id") references "addresses" ("id") on update cascade on delete set null;');
  }
